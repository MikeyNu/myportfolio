...
export const services: ServiceDefinition[] = [
  {
    ...
    lightImage: RENDERS.services3Light
  },
  {
    id: '3d',
    index: '02',
    ...
    lightImage: RENDERS.services2Light
  },
  {
    id: 'vr',
    index: '03',
    ...
    lightImage: RENDERS.services1Light
  }
];
...
export const processSteps = [
  {
    index: '01',
    title: 'Discover',
    description: 'Goals, users, constraints, and success criteria before any production decision.'
  },
  {
    index: '02',
    title: 'Define',
    description: 'Brief to structure: scope, direction, system plan, and delivery path.'
  },
  {
    index: '03',
    title: 'Design',
    description: 'Interface, space, assets, and visual language shaped to real requirements.'
  },
  {
    index: '04',
    title: 'Develop',
    description: 'Build, integrate, and refine to production quality.'
  },
  {
    index: '05',
    title: 'Deliver',
    description: 'Files, builds, assets, and documentation to the agreed standard.'
  }
];
...
export const capabilities = [
  {
    ...
    description: 'Web, mobile, platforms, backend, APIs, and interactive 3D experiences.',
    icon: RENDERS.approach3
  },
  {
    index: '02',
    title: '3D production',
    description: 'Modeling, texturing, rendering, animation, spatial design, and visualization.',
    icon: RENDERS.approach4
  },
  {
    index: '03',
    title: 'Immersive delivery',
    description: 'VR environments, real-time experiences, spatial interaction, and XR delivery.',
    icon: RENDERS.approach5
  },
  {
    index: '04',
    title: 'Creative direction',
    description: 'One visual language across interface, spatial, 3D, and immersive work.',
    icon: RENDERS.approach6
  }
];
