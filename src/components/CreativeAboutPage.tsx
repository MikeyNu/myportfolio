  ...
  return (
    <div className="cinematic-page about-page">
      <section className="cinematic-container cinematic-grid about-hero" aria-labelledby="about-title">
        <div className="about-copy">
          ...
          <p className="cinematic-copy about-lead">
            I design and build digital and spatial experiences by combining software development, 3D production, and immersive technology. The work moves from systems and interfaces to environments and real-time interaction, with each discipline used where it makes the final experience clearer, stronger, and more useful.
          </p>
      ...
      <section className="cinematic-container about-lower-band" aria-label="Approach details">
        <article className="about-band-section">
          ...
          <p className="about-philosophy-copy">
            Good work is not defined by how many visual effects or components it contains. It is defined by whether structure, interaction, imagery, and technology all support the same purpose.
          </p>
          <p className="about-philosophy-copy">
            Every project is an opportunity to shape how people understand, navigate, and experience a digital or spatial system.
          </p>
        </article>
      ...
      <div className="about-quote" aria-label="Design philosophy statement">
        We do not just design interfaces. We design how they are felt.
      </div>
